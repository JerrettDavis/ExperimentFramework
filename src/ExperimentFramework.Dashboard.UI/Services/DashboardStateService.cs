...
/// <summary>
/// Centralized state service for the dashboard.
...
public class DashboardStateService
{
    ...
    /// </summary>
    public void SyncVariantsFromApi(List<ExperimentInfo> experiments)
    {
    ...
    /// <summary>
    /// Syncs kill switches from API response.
    /// </summary>
    public void SyncKillSwitchesFromApi(List<KillSwitchStatus> killSwitches)
    {
        foreach (var status in killSwitches)
        {
    ...
    /// <summary>
    /// Syncs active plugin implementations from API response.
    /// </summary>
    public void SyncPluginImplementationsFromApi(Dictionary<string, ActivePluginImplementation> implementations)
    {
...
/// <summary>
/// Represents an active plugin implementation.
/// </summary>
